<template>
    <UContainer class="flex gap-5 flex-col py-5">
        <UCard class="address-section">
            ...
            <div
                v-if="status === 'pending'"
                class="flex gap-4 mt-5 items-center"
            >
            ...
            <div v-else class="flex gap-20 mt-5 items-center">
                ...
                <p class="text-black/80">
                    {{ addressSelected?.detail_address }}
        ...
        <div class="bg-white divide-y divide-dashed">
            <div class="p-6">
                <div class="flex justify-between items-center">
                    <span
                        class="w-[33%] text-lg font-normal text-black/85 mb-4"
                    >
                        Produk Dipesan
                    </span>
                    <span class="w-[16%]" />
                    <span
                        class="w-[16%] text-sm font-normal text-right text-black/55"
                    >
                        Harga satuan
                    </span>
                    <span
                ...
                <div>
                    ...
                    >
                        ...
                        <div
                            class="w-[16%] text-sm font-normal text-right text-black/80"
                        >
                            Rp{{
                                formatNumber(
                        ...
                        <div
                            class="w-[16%] text-sm font-medium text-right text-black/80"
                        >
            ...
            <div class="bg-blue-50/20 flex divide-x divide-dashed">
                <div
                    class="py-4 px-6 flex gap-4 w-[480px] items-start justify-center"
                >
                    <span>Pesan:</span>
                    <UInput
                        v-model="notes"
                    ...
                    <div class="grid grid-cols-3 px-6 py-9 font-medium">
                        ...
                        <div>
                            ...
                            >
                                ...
                                {{
                                    getEstimate(
                                        data?.data?.cart?.courier_estimation,
                                    )
                                }}
                            </p>
                        </div>
                        <p class="text-sm text-black/80 text-right">
                            Rp{{
                                formatNumber(
                                    data?.data?.cart?.courier_price || 0,
                                )
                            }}
                        </p>
                    </div>
            ...
            <div
                class="bg-blue-50/20 flex justify-end px-6 py-4 items-center gap-3"
            >
                ...
                <table class="price-summary">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right min-w-44">
                                Rp{{
                                    formatNumber(data?.data?.cart?.service_fee)
                                }}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td
                                class="text-right min-w-44 text-3xl text-primary"
                            >
                                Rp{{
                                    formatNumber(
                                        data?.data?.cart?.total_payment,
                                    )
                                }}
                            </td>
                        </tr>
